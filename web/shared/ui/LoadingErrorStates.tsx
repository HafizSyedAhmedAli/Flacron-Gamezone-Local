  ...
  return (
    <div className="flex items-center justify-center py-20">
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full blur-2xl animate-pulse" />
        <div className="relative bg-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 flex flex-col items-center gap-4">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full blur-md opacity-30 animate-pulse" />
            <Loader2
              className="relative w-12 h-12 text-blue-400 animate-spin"
              strokeWidth={2.5}
            />
          </div>
...
export function EmptyState({
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-800/30 to-slate-900/30 rounded-2xl blur-xl" />
      <div className="relative text-center py-24 bg-slate-900/30 backdrop-blur-sm rounded-2xl border border-slate-700/50">
        {icon && (
          <div className="relative w-20 h-20 mx-auto mb-6">
            <div className="absolute inset-0 bg-gradient-to-br from-slate-600/20 to-slate-700/20 rounded-2xl blur-lg" />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-slate-700/5 to-transparent rounded-full blur-3xl pointer-events-none" />
      </div>
    </div>
  );
}
