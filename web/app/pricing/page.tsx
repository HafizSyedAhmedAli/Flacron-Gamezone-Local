...
import { Check, Sparkles, Zap, Crown, Shield, Clock, CreditCard, HelpCircle, Star } from "lucide-react";
...
export default function PricingPage() {
  ...
  const handleCheckout = async (plan: "free" | "premium") => {
    ...
    try {
      ...
      console.log("Checkout initiated for:", billingCycle);
    } catch (error) {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-16">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm text-blue-400 font-semibold">Premium Gaming Experience</span>
          </div>
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            Choose the perfect plan for your Flacrom Gamezone experience. Unlock exclusive features and dominate the competition.
          </p>
        </div>
        ...
        <div className={`flex justify-center mb-12 transition-all duration-1000 delay-150 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-flex items-center bg-slate-800/50 border border-slate-700/50 rounded-xl p-1.5 backdrop-blur-xl shadow-lg">
            ...
            >
              Yearly
              <span className="absolute -top-2 -right-2 bg-green-500 text-white text-xs px-2 py-0.5 rounded-full font-semibold animate-bounce" style={{ animationDuration: '2s' }}>
                Save 17%
              </span>
            </button>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
            ...
            <div className="relative bg-gradient-to-b from-slate-800/95 to-slate-900/95 backdrop-blur-2xl border border-slate-700/50 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:transform hover:-translate-y-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Perfect for casual gamers</p>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-xl border-2 border-slate-600 text-white font-semibold hover:bg-slate-700/50 hover:border-slate-500 transition-all duration-300 mb-8 hover:transform hover:scale-105"
              >
                Get Started Free
              </button>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3 text-slate-300 animate-slideIn" style={{ animationDelay: `${index * 0.1}s` }}>
          ...
          >
            ...
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-10">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2 animate-pulse" style={{ animationDuration: '2s' }}>
            ...
            <div className="relative bg-gradient-to-b from-slate-800/95 to-slate-900/95 backdrop-blur-2xl border-2 border-blue-500/50 rounded-2xl p-8 shadow-2xl shadow-blue-500/20 hover:shadow-blue-500/30 transition-all duration-300 hover:transform hover:-translate-y-2">
              <div className="flex items-center gap-3 mb-4 mt-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">Premium Tier</h2>
                  <p className="text-sm text-slate-400">For competitive players</p>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                {billingCycle === "yearly" && (
                  <p className="text-sm text-green-400 mt-2 flex items-center gap-1">
                    ...
                    ${yearlyPrice}/year - Save ${((monthlyPrice * 12) - yearlyPrice).toFixed(2)} annually
                  </p>
                )}
              </div>
              ...
              <button
                ...
                className="relative w-full group/btn overflow-hidden mb-8"
              >
        ...
        {/* FAQ Section */}
        <div className={`max-w-3xl mx-auto transition-all duration-1000 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            {[
              {
                ...
                answer: "Absolutely! You can change your plan at any time from your dashboard. Changes take effect immediately, and we'll prorate any charges to ensure you only pay for what you use."
              },
              {
                question: "Is there a free trial for Premium?",
                answer: "Yes! New Flacrom Gamezone users get 7 days of premium access completely free. Experience all premium features with no credit card required to start your trial."
              },
              {
                question: "What payment methods do you accept?",
                answer: "We accept all major credit cards (Visa, Mastercard, American Express, Discover), PayPal, and popular digital wallets through our secure Stripe payment gateway."
              },
              {
                question: "Can I cancel my subscription anytime?",
                answer: "Yes, you can cancel your subscription at any time with no questions asked. You'll continue to have full premium access until the end of your current billing period."
              },
              {
                question: "Do you offer student or team discounts?",
                answer: "Yes! We offer special pricing for students (with valid .edu email) and team subscriptions. Contact our support team at billing@flacromgamezone.com for custom pricing options."
              }
            ].map((faq, index) => (
              <div 
                key={index} 
        ...
        <div className={`mt-16 text-center transition-all duration-1000 delay-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <p className="text-slate-500 text-sm mb-6">Trusted by over 50,000+ gamers worldwide</p>
